...
Gem::Specification.new do |s|
  ...
  s.post_install_message = "\nlingo-1.10.2 [2019-02-05]:\n\n* Fixed regression introduced in 1.9.0 where source form was assumed to be a\n  Lingo::Language::Token (issue reported by Leonhard Maylein).\n\n".freeze
  s.rdoc_options = ["--title".freeze, "lingo Application documentation (v1.10.2)".freeze, "--charset".freeze, "UTF-8".freeze, "--line-numbers".freeze, "--all".freeze, "--main".freeze, "README".freeze]
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<pdf-reader>.freeze, ["~> 2.1"])
      ...
      s.add_dependency(%q<pdf-reader>.freeze, ["~> 2.1"])
