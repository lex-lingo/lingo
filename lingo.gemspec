...
Gem::Specification.new do |s|
  ...
  s.rdoc_options = ["--title".freeze, "lingo Application documentation (v1.10.0)".freeze, "--charset".freeze, "UTF-8".freeze, "--line-numbers".freeze, "--all".freeze, "--main".freeze, "README".freeze]
